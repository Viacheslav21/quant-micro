...
_BINARY_RISK_PATTERNS = [
    ...
    re.compile(r"^\s*exact score:", re.I),             # "Exact Score: Arsenal 2 - 2 Atletico" — NO collapses to 0 if live score hits the exact value mid-match (-$92 in two trades on 2026-05-05)
]
