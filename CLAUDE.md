...
- **Binary risk filter**: Blocks markets where price jumps to 0 instantly: range bets ("between $X and $Y"), coin flips ("Up or Down", "Green or Red", "Higher or Lower"), per-game/per-map esports winner markets ("Game 2 Winner", "Map 3 Winner") — a single live game resolves in 15-40 min and can flip from 95¢+ to $0 on a single upset. Soccer "end in a draw" bets — binary Win/Draw/Loss outcome. Crypto price-level markets ("Bitcoin above $76k", "BTC reach $80k", "ETH exceed $3,500") — BTC/ETH can flash-crash through a price target in minutes, identical risk profile to esports per-game. BO3/BO5 series winner markets are allowed.
